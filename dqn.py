...
class DQN:
    def __init__(self, num_states, num_actions):
        ...
        self.eval_net = DQNNetwork(num_states, num_actions).to(self.device)
        self.target_net = DQNNetwork(num_states, num_actions).to(self.device)
    ...
    def learn(self):
        ...
        # Removed the incorrect unpacking:
